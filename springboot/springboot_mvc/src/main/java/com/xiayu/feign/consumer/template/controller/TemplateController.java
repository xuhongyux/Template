package com.xiayu.feign.consumer.template.controller;


import com.xiayu.feign.consumer.template.dto.RequestDto;
...
public class TemplateController{
    ...
    @PostMapping("/test")
    public String test(@RequestBody RequestDto userName){
