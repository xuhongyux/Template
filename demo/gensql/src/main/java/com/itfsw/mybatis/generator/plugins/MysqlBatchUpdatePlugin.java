...
import com.itfsw.mybatis.generator.tools.MethodGeneratorTool;
import com.itfsw.mybatis.generator.tools.SqlMapperGeneratorTool;
...
public class MysqlBatchUpdatePlugin extends PluginAdapter {
    ...
    public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        if (introspectedTable.getTargetRuntime().equals(IntrospectedTable.TargetRuntime.MYBATIS3)) {
            MethodGeneratorTool.defaultBatchInsertOrUpdateMethodGen(MethodGeneratorTool.UPDATE,
                    interfaze,
                    introspectedTable,
                    context);
        }
    ...
    public void addSqlMapper(Document document, IntrospectedTable introspectedTable) {
        ...
        //primaryKey的JAVA变量
        String primaryKeyParameterClause = MyBatis3FormattingUtilities.getParameterClause(introspectedTable.getPrimaryKeyColumns()
                .get(0), "item.");
        ...
        for (int i = 0; i < columnList.size(); i++) {
            ...
            String ifNullSql = String.format("when %s then %s",
                    primaryKeyParameterClause,
                    tableName + "." + columnName);
            XmlElement ifNullElement = SqlMapperGeneratorTool.baseIfJudgeElementGen(columnJavaTypeName,
                    ifNullSql,
                    true);
            ...
            XmlElement caseTrimElement = SqlMapperGeneratorTool.baseTrimElement(columnName + " =case " + primaryKeyName,
                    "end,",
                    null);
