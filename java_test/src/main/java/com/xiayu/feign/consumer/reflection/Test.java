...
public class Test {
    ...
    public static void main(String[] args) {
        try {
            /*以下调用无参的、私有构造函数*/
            Class<?> userpo = Class.forName("com.xiayu.feign.consumer.reflection.UserPo");
            //设置构造方法的 安全等级
            ...
            /*以下调用带参的、私有构造函数*/
            Class<?> userPoParam = Class.forName("com.xiayu.feign.consumer.reflection.UserPo");
             ...
             * 有参  public
             */
            Class<?> userPoParamPublic = Class.forName("com.xiayu.feign.consumer.reflection.UserPo");
